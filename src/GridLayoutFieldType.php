...
namespace mhartwig\gridlayoutfieldtype;
 ...
 */
class GridLayoutFieldType extends Plugin
{
    // Static Properties
    // =========================================================================
     ...
     * GridLayoutFieldType::$plugin
     *
     * @var GridLayoutFieldType
     */
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = GridLayoutField::class;
            }
        );
 ...
 */
    ...
    protected function settingsHtml(): string
    {
        return Craft::$app->view->renderTemplate(
            'grid-layout-field-type/settings',
            [
