...
namespace mhartwig\gridlayoutfieldtype\fields;

use mhartwig\gridlayoutfieldtype\GridLayoutFieldType;
use mhartwig\gridlayoutfieldtype\assetbundles\gridlayoutfield\GridLayoutFieldAsset;
 ...
 * @since     1.0.0
 */
class GridLayout extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('grid-layout-field-type', 'Grid Layout');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            ...
            [
                'field' => $this,
                //'rows' => $this->getSettings()->numberOfRows,
                //'columns' => $this->getSettings()->numberOfColumns,
            ]
        );
    }
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(GridLayoutFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').GridLayoutFieldTypeGridLayout(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'grid-layout-field-type/_components/fields/GridLayout_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
